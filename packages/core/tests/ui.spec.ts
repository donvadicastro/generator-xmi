...
describe('xmiParser', () => {
  describe('UI', () => {
    const data = readJSONSync(path.resolve(__dirname, '../../../resources/models/project8_ui.json'));
  ...
  describe('UI iteractions', () => {
    ...
    beforeEach(async () => {
      const data = readJSONSync(path.resolve(__dirname, '../../../resources/models/project8_ui_iteraction.json'));
      const parser = new XmiParser(data);
