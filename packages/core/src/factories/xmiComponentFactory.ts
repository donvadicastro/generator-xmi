...
import {xmiCollaboration} from "../entities";
import {xmiDiagram} from "../entities";
import {xmiScreen} from "../entities";
import {xmiGUIElement} from "../entities";
import {xmiUMLDiagram} from "../entities";
import {xmiMessageEndpoint} from "../connectors/xmiMessageEndpoint";
import {xmiAttribute} from "../entities";
import {xmiInOut} from "../entities/component/xmiInOut";
import {xmiUseCase} from "../entities";
import {xmiLifeline} from "../entities";
...
import {xmiInstanceSpecification} from "../entities";
import {xmiCombinedFragment} from "../entities/collaboration/xmiCombinedFragment";
import {get} from 'object-path';
import {xmiComment} from "../entities";
import {xmiComponent} from "../entities";
import {xmiActor} from "../entities";
import {xmiBoundary} from "../entities";
import {xmiProvided} from "../entities/component/xmiProvided";
import {xmiEnumeration} from "../entities";
import {xmiDataType} from "../entities";
import {xmiClass} from "../entities";
import {xmiText} from "../entities";
...
export class xmiComponentFactory {
    ...
    connectorHash: { [name: string]: xmiConnector } = {};
    ...
    resolveById(id: string): Observable<xmiBase | undefined> {
        const subscription = this.resolvedElements.pipe(last((x) => x.id === id));
